 ...
 *     Battery Box Cover
 */
module BatteryBoxCover(batteryDiameter=15, batteryHeight=55, cThickness = 4, tabThickness = 2, screwDiameter =3, headDiameter=6, mountWidth=10, tabWidth=5, numBatteries = 4, rim = .5, tolerance=0.1)
{
